...
$sql = "select tb_course.course_id,tb_course.course_name,tb_course.course_intro,tb_course.course_time,tb_course.teacher_id,tb_teacher.teacher_name from ((tb_course join tb_choose on tb_course.course_id=tb_choose.course_id) join tb_student on tb_student.student_id=tb_choose.student_id) join tb_teacher on tb_teacher.teacher_id=tb_course.teacher_id where tb_student.student_id='$user->linkID'";
